...
public class MainActivity extends SharedMediaActivity implements MediaClickListener, AlbumsFragment.AlbumClickListener, NothingToShowListener, EditModeListener, ItemListener
{
    ...
    @BindView(R.id.fab_camera)//This annotation is the id attached to the floatingactionbutton
    ...
    public void onCreate(@Nullable Bundle savedInstanceState)
    {
        ...
        unbinder = ButterKnife.bind(this); //ButterKnife uses annotations to bind views e.g line 88. Now we dont have to findViewById for every view.

        initUi();
        pickMode = getIntent().getBooleanExtra(ARGS_PICK_MODE, false);

        // savedInstanceState will be null only when app is first launched
        ...
        //savedInstanceState contains data of the state of your activity before it was placed into the background[onPause()] or its orientation was changed.
        //Suppose, you have a simple fragment with a TextView and a Button. Each time you clicked the button the text changes.
        // Change the orientation of you device and notice that you lost the data and fragment starts as the first time again.
        // By using Bundle savedInstanceState we can get rid of this. If you take a look into the life cyle of the fragment.Fragment Lifecylce
        // you will get that a method "onSaveInstanceState" is called when the fragment is about to destroyed (line 169)
